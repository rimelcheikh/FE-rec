...
base_path_experiment = "./experiments/SCN/AN/"
...
def run_training():
  ...
  if not os.path.isdir(os.path.join(base_path_experiment, name_experiment)):
      os.makedirs(os.path.join(base_path_experiment, name_experiment))
  ...
  for fold in range(0, num_folds):
      ...
      train_dataset = load_an.AffectNetCategorical(fold, idx_set=0,
      ...
      val_dataset = load_an.AffectNetCategorical(fold, idx_set=1,
                                              max_loaded_images_per_label=1000000,
      ...
      test_dataset = load_an.AffectNetCategorical(fold, idx_set=2,
                                    max_loaded_images_per_label=1000000,
                                    transforms=transforms.Grayscale(num_output_channels=3),
                                    base_path_to_affectnet='C:/Users/rielcheikh/Desktop/FER/DB/AffectNet/')
