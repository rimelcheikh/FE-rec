...
def parse_args():
    ...
    parser.add_argument('--ckPlus_path', type=str, default='C:/Users/rielcheikh/Desktop/FER/DB/CK+', help='CK+ dataset path.')
...
base_path_experiment = "./experiments/SCN/CK/"
name_experiment = "exp_rel"
...
def run_training():
    ...
    for fold in range(0, num_folds):
        ...
        if not imagenet_pretrained:
          ...
          print("Done initializing weights for ResNet18")
        ...
        train_dataset = load_ck.CohnKanade(fold, 'training',
                                       transforms=transforms.Compose(data_transforms),
                                       base_path_to_dataset='C:/Users/rielcheikh/Desktop/FER/DB/CK+/')
        ...
        val_dataset = load_ck.CohnKanade(fold, 'validation',
        ...
        test_dataset = load_ck.CohnKanade(fold, 'testing',
                                           transforms=transforms.Compose([transforms.Grayscale(num_output_channels=3),
                                                                          transforms.Resize(96),]),
                                           base_path_to_dataset='C:/Users/rielcheikh/Desktop/FER/DB/CK+/')
        ...
        for i in range(1, args.epochs + 1):
            ...
            print('[Epoch %d Training] loss: %.3f | acc: %.4f. ' % (i, running_loss, acc))
            ...
            with torch.no_grad():
                ...
                print("[Epoch %d Validation] loss: %.3f | acc: %.4f " % (i, running_val_loss, val_acc))
